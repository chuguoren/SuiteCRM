...
class Email extends SugarBean {
    ...
    function email2Send($request)
    {
        ...
        $this->description_html = '&lt;html&gt;&lt;body&gt;' .
            $request['sendDescription'] . '&lt;/body&gt;&lt;/html&gt;';
        ...
        if ((!(empty($orignialId) || isset($request['saveDraft']) ||
                ($this->type === 'draft' && $this->status === 'draft'))) &&
            (($request['composeType'] === 'reply') || ($request['composeType'] === 'replyAll') ||
                ($request['composeType'] === 'replyCase')) && ($orignialId != $this->id)
        ) {
